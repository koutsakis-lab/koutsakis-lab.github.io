...
profiles:
  # Each entry pairs a headshot in assets/img/people/ with a short bio file in
  # _pages/people/. To add someone: drop in a photo, copy one of the bio files,
  # and add a block here.
  - align: left
    content: people/header_faculty.md
  - align: right
    image: people/koutsakis.jpg
    content: people/about_koutsakis.md

  - align: left
    content: people/header_grad.md
  - align: left
    image: people/vrocharis.jpeg
    content: people/grad/about_vrocharis.md
  - align: left
